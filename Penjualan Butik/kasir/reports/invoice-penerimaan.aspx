<%@ Page Language="VB" AutoEventWireup="false" CodeFile="invoice-penerimaan.aspx.vb" Inherits="kasir_reports_invoice_penerimaan" %>
...
<head>
    ...
    <title>Invoice Penerimaan | Penjualan Butik</title>
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Invoice Penerimaan</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="../../Default.aspx">Reports</a></li>
                                    <li class="breadcrumb-item active">Invoice Penerimaan</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="invoice p-3 mb-3 callout callout-info" id="ContentToPrint">
                                    ...
                                    <div class="row invoice-info">
                                        <div class="col-sm-4 invoice-col">
                                            ...
                                            <address>
                                                <strong>
                                                    <asp:Label ID="TXTSUPPLIER2" runat="server"></asp:Label>.</strong><br>
                                                <asp:Label ID="TXTSUPPLIERALAMAT" runat="server"></asp:Label><br>
                                                Telp:
                                                <asp:Label ID="TXTSUPPLIERTELP" runat="server"></asp:Label>
                                        ...
                                        <div class="col-12 table-responsive">
                                            <asp:GridView ID="GVBARANG" runat="server" CssClass="table table-striped"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="JUMLAH_MASUK" HeaderText="Qty" ReadOnly="True" />
                                                    ...
                                                    <asp:BoundField DataField="HARGA_BELI" HeaderText="SubTotal" ReadOnly="true" DataFormatString="{0:C2}" />
                                                </Columns>
                                            </asp:GridView>
                                        </div>
                                        <!-- /.col -->
