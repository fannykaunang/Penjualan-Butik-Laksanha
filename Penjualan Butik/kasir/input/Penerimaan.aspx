<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Penerimaan.aspx.vb" Inherits="kasir_input_Penerimaan" %>
...
<head>
    ...
    <title>Input Penerimaan | Penjualan Butik</title>
                ...
                <section class="content">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <asp:LinkButton ID="ButtonCancel" runat="server" CssClass="btn btn-danger" Style="display: none" OnClick="LinkButton1_Click"><i class="fa fa-minus-circle"></i> Reset</asp:LinkButton>
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel2" runat="server" EnableViewState="false">
                                                    <ContentTemplate>
                                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                                            ...
                                                            SelectCommand="SELECT DISTINCT NAMA_SUPPLIER FROM T_SUPPLIER"></asp:SqlDataSource>
                                                        <asp:DropDownList ID="TXTSUPPLIER" AppendDataBoundItems="true" CssClass="form-control select2"
                                                            Style="width: 100%;" runat="server" DataSourceID="SqlDataSource1" DataTextField="NAMA_SUPPLIER"
                                                            OnSelectedIndexChanged="TXTSUPPLIER_SelectedIndexChanged" AutoPostBack="true" EnableViewState="false">
                                                            <asp:ListItem>--Pilih--</asp:ListItem>
                                                        </asp:DropDownList>
                                                        <asp:HiddenField ID="TXTIDSUPPLIER" runat="server" />
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="TXTSUPPLIER" EventName="SelectedIndexChanged" />
                                                    </Triggers>
                                                </asp:UpdatePanel>
                                        ...
                                        <ContentTemplate>
                                            <div class="table-responsive">
                                                <asp:GridView ID="GVBARANG" runat="server" CssClass="table table-bordered table-striped table-hover js-basic-example dataTable" AutoGenerateColumns="False" EnableSortingAndPagingCallbacks="false"
                                                    DataKeyNames="KODE_BARANG" OnRowDataBound="GVBARANG_RowDataBound" Font-Size="X-Small" GridLines="Both" AllowPaging="True" OnPageIndexChanging="GVBARANG_PageIndexChanging" PageSize="5" PagerStyle-CssClass="pagination-ys">
                                                    <Columns>
                            ...
                            <div class="card card-widget widget-user">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="description-block">
                                                <h5 class="description-header"><a id="modal-hrgjual-barang"></a></h5>
    ...
    reserved.
     ...
     https://firebase.google.com/docs/web/setup#config-web-app -->
        ...
        <script>
            ...
            var firebaseConfig = {
                apiKey: "AIzaSyDNZW6ucs8VGLGx4hUGAP4NbOGpMf3vqjY",
                authDomain: "penjualan-butik-memberamo.firebaseapp.com",
                databaseURL: "https://penjualan-butik-memberamo.firebaseio.com",
                projectId: "penjualan-butik-memberamo",
                storageBucket: "",
                messagingSenderId: "476440171949",
                appId: "1:476440171949:web:ba95d4b7658aa451"
            };
            // Initialize Firebase
        ...
        <script>
            function getCalculationGrid(button) {
                ...
                if ($('#TXTFAKTUR').val() == '') {
                    ...
                    return false;
                } else if ($('#TXTSUPPLIER').val() == '--Pilih--') {
                    isValid = false;
                    $("[id*=TXTSUPPLIER]").focus();
                    $("[id*=LBINFOSUPPLIER]").text("Silahkan pilih Supplier!");
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $("#TXTFAKTUR").keyup(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '<%=ResolveUrl("~/kasir/input/Penerimaan.aspx/GET_FAKTUR")%>',
                ...
                $("body").on("click", "[id*=Gridview1] [id*=LNKNAMABARANG]", function () {
                    var kodebrg = $(this).closest("tr").find("[id*=HF_ID_BARANG]").val();
                    var brg = $(this).text();
                    ...
                    $.ajax({
                        type: "POST",
                        url: "Penerimaan.aspx/GET_DETAIL_BARANG",
                        ...
                        success: function (data) {
                            if (data.d.length > 0) {
                                ...
                                $('#modal-hrgjual-barang').text('Rp.' + data.d[0].split('-')[9]);
                ...
                $('body').on('click', '[id*=Button1]', function () {
                    ...
                    function getInsertFromAjax() {
                        ...
                        var TXTIDSUPPLIER = $("[id*=TXTIDSUPPLIER]");
                        ...
                        for (i = 0; i < parseInt(x.length); i++) {
                            (function (index) {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "Penerimaan.aspx/GET_INSERT_DATA",
                                    data: '{INVOICE_PENERIMAAN: "' + TXTFAKTUR.val() + '", ID_BARANG: "' + explodedKdBarang[cnt] + '", KODE_SUPPLIER: "' + TXTIDSUPPLIER.val() + '", TANGGAL_MASUK: "' + TXTTGLPENERIMAAN.val() + '", JUMLAH_MASUK: "' + explodedJUMBELI[cnt] + '", STOK: "' + explodedStokAkhir[cnt] + '", HARGA_BELI: "' + explodedHARGABELI[cnt] + '", TOTAL_HARGA: "' + TXTTOTALHARGABELI.text() + '", KETERANGAN: "' + TXTKETERANGAN.val() + '" }',
                                    contentType: "application/json; charset=utf-8",
                                    dataType: "json",
                                    error: OnErrorOrFailure,
                                    failure: OnErrorOrFailure,
                                    ...
                                    success: function (response) {
                                        ...
                                        //setTimeout(function () {
                                        //window.location.href = '../message/success.aspx?PreviousPage=Penerimaan.aspx&nama_barang=' + explodedNamaBarang;
                                        //}, 4000);
                                        return false;
                                    }
                                });
                ...
                $("body").on("click", "[id*=ButtonAdd]", function (e) {
                    ...
                    //alert(validateCountDefault.length);
                    if (validateCountDefault.length > 0) {
                        //alert('Masih ada ' + validateCountDefault.length + ' lagi yang masih kosong, harap diisi!!!');
                        ...
                        var contactdiv = '<tr class="data-class_' + rowCount + '">' +
                            ...
                            //'<td align="right"><a onclick="return false;" id="Gridview1_ButtonAdd_' + rowCount + '" class="addButton btn btn-primary" href="javascript:__doPostBack(&#39;Gridview1$ctl02$ButtonAdd&#39;,&#39;&#39;)" style="font-size:X-Small;"><i class="fa fa-plus"></i> Tambah</a></td>' +
                            '</tr>';
                ...
                $("body").on("click", "[id*=BTINSERTDATATABLE]", function (e) {
                    ...
                    //    //var kdbrg = $(this).find("[id*=TXTKDBARANG]").text();
                    //    var kdbrg = $(this).find("input[type=hidden]").val();
                    //    if (kdbrg != null) {
                    //        alert(kdbrg);
                    //        return;
                    //    }
                    ...
                    var thisFormGroup;
                    var thisSpan; //= $(".validate").find(".spanDefault");
                ...
                //$("body").on("click", "[id*=BTBATAL]", function () {
                ...
                //            Authorization: 'key=' + 'AAAAbu4MFa0:APA91bFipM6MRrA3nrE134IoZk_oqb7TzJoPxXPcGdK5oJ_ZtQWkXy_cEfL8Zm6KQWbabgGvxWgLn1hKeHKGta4vvHzNDsprYcKbwCW43f_0rumCsevFGSVNBrHDjTPlJstuxk187jCc',
                //            Sender: 'id=476440171949',
                ...
                $("body").on("click", "[id*=btCheck]", function () {
                    ...
                    for (var rowCount = 0; rowCount < countchecked; rowCount++) {
                        var contactdiv = '<tr class="data-class_' + rowCount + '">' +
                            '<td class="count">' + parseInt(rowCount + 1) + '</td>' +
                            '<td class="count"><a href="#" id="Gridview1_BTSHOWSPAREPART_' + rowCount + '" style="font-size: x-large" data-toggle="modal" data-target="#divBarang"><i class="fa fa-plus-circle" aria-hidden="true"></i></a>&nbsp;<a href="#" id="Gridview1_BTDELETESPAREPART_' + rowCount + '" style="font-size: x-large"><i class="fa fa-times-circle" aria-hidden="true"></i></a></td>' +
                            '<td class="count"><div id="Gridview1_valKdBarang_' + rowCount + '" class="form-group default has-success"><div class="col-sm-10"><span id="Gridview1_TXTKDBARANG_' + rowCount + '" class="InputKdBarang" style="font-size:Small;">' + kdbarang[rowCount] + '</span><input name="Gridview1$ctl02$HF_ID_BARANG' + rowCount + '" type="hidden" id="Gridview1_HF_ID_BARANG_' + rowCount + '" value="' + idbarang[rowCount] + '" class="inputIDBarang" /><span id="LBINFOKDBARANG" style="font-size: x-small" class="help-block spanDefault"></span></div></div></td>' +
                            '<td id="tdvalNamaBarang" class="count"><div id="Gridview1_valNamaBarang_' + rowCount + '" class="form-group default has-success"><div class="col-sm-10"><a id="Gridview1_LNKNAMABARANG_' + rowCount + '" class="InputBarang" href="javascript:__doPostBack("Gridview1$ctl0' + rowCount + '$LNKNAMABARANG","")" style="font-size:Small;">' + namabarang[rowCount] + '</a><span id="Gridview1_TXTNAMABARANG_0" style="font-size:Small;"></span><span id="LBINFONAMABARANG' + rowCount + '" style="font-size:x-small" class="help-block spanDefault"></span></div></div></td>' +
                            '<td class="count"><div id="Gridview1_valQty_' + rowCount + '" class="form-group default has-success"><div class="col-sm-10"><span id="Gridview1_TXTSTOKAKHIR_' + rowCount + '" class="StokAkhir" style="font-size:Small;">' + GET_STOK_BARANG(kdbarang[rowCount]) + '</span><span id="LBINFOQty" style="font-size:x-small" class="help-block spanDefault"></span></div></div></td>' +
                            '<td class="count"><div id="Gridview1_valJumBeli_' + rowCount + '" class="form-group default has-error"><div class="col-sm-10"><input name="Gridview1$ctl02$TXTJUMBELI' + rowCount + '" type="text" id="Gridview1_TXTJUMBELI_' + rowCount + '" class="form-control InputJUMBELI" style="font-size:Small;" /><span id="LBINFOJUMBELI" style="font-size:x-small" class="help-block spanDefault"></span></div></div></td>' +
                            '<td class="count"><div id="Gridview1_valHargaBeli_' + rowCount + '" class="form-group default has-success"><div class="col-sm-10"><input name="Gridview1$ctl02$TXTHARGABELI' + rowCount + '" type="text" id="Gridview1_TXTHARGABELI_' + rowCount + '" class="form-control InputHARGABELI" value="' + GET_HARGA_BELI(kdbarang[rowCount]) + '" style="font-size:Small;" /><span id="LBINFOHARGABELI" style="font-size:x-small" class="help-block spanDefault"></span></div></div></td>' +
                            '<td class="count"><div id="Gridview1_valSubTotal_' + rowCount + '" class="form-group default has-success"><div class="col-sm-10"><span id="Gridview1_TXTSUBTOTAL_' + rowCount + '" class="InputSubTotal" style="font-size:Small;"></span><span id="LBINFOSUBTOTAL" style="font-size: x-small" class="help-block spanDefault"></span></div></div></td>' +
                            '</tr>';
                        $('#Gridview1').append(contactdiv);
                        $('#HFIDXSPAREPART').val(parseInt(rowCount));
                        ...
                        totals += parseFloat(GET_HARGA_BELI(kdbarang[rowCount]));
                        $("[id*=TXTTOTALHARGABELI]").text('Rp. ' + Comma(totals));
                        $("[id*=ButtonCancel]").css("display", "inline");
                    }
                ...
                function GET_STOK_BARANG(KDBARANG) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '<%=ResolveUrl("~/kasir/input/Penerimaan.aspx/GET_STOCK")%>',
                ...
                function GET_HARGA_BELI(KDBARANG) {
                    var kdBuku;
                    $.ajax({
                        type: "POST",
                        url: '<%=ResolveUrl("~/kasir/input/Penerimaan.aspx/GET_HARGA_BELI")%>',
                        data: JSON.stringify({ "KDBARANG": KDBARANG }),
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        async: false,
                ...
                $("body").on("keyup", "[id*=Gridview1] [id*=TXTJUMBELI]", function () {
                    ...
                    //if (parseFloat(kurangiStok.val()) > parseFloat(stok)) {
                    //    alertify.error('<img id="Image2" src="../../dist/img/Action_Close_32x32.png" style="height:30px;width:30px;" /><strong> Error!</strong> </br>Sudah diperingatkan agar tidak mengisi Jumlah Beli melebihi stok!!!!!');
                    //    $(kurangiStok).val('');
                    //    //$(kurangiStok).closest("tr").find("[id*=TXTTOTAL]").val('');
                    //    $("[id*=TXTTOTALHARGABELI]").text('Rp.0');
                    //    //return false;
                    //}
                    ...
                    for (i = 0; i < x.length; i++) {
                        ...
                        if (!jQuery.trim($(kurangiStok).val()) == '') {
                            if (!isNaN(parseFloat($(kurangiStok).val()))) {
                                ...
                                //var total = parseFloat($("[id*=TXTHARGAJUAL]", row).val().replace(/,/g, "")) * parseFloat($(this).val());
                                var total = parseFloat($("[id*=TXTHARGABELI]", row).val()) * parseFloat(kurangiStok.val());
                                //$("[id*=TXTTOTAL]", row).val(parseFloat(total));
                                $("[id*=TXTSTOKAKHIR]", row).text(parseFloat(stok) + parseFloat(kurangiStok.val()));
                                $("[id*=TXTSUBTOTAL]", row).text(total);

                                totals += parseFloat($("[id*=TXTHARGABELI]", row).val());
                                $("[id*=TXTTOTALHARGABELI]").text('Rp.' + Comma(totals));
                                //$('#myhiddenField').val($(kurangiStok).val());
                                ...
                                //}, 4000);
                                //$("[id*=TXTBAYAR]").focus();
                                //$('#Panel1').show().css('visibility', 'visible');
                                //$('#BTINSERTDATATABLE').show().css('visibility', 'visible');
                            }
                        } else {
                            $(kurangiStok).val('0');
                        }
                    ...
                    for (i = 0; i < x.length; i++) {
                        ...
                        if (!jQuery.trim($(kurangiStok).val()) == '') {
                            if (!isNaN(parseFloat($(kurangiStok).val()))) {
                                ...
                                var row = $(kurangiStok).closest("tr");
                                //var total = parseFloat($("[id*=TXTHARGABELI]", row).val()) * parseFloat($(kurangiStok).val());
                                //$("[id*=TXTSTOKAKHIR]", row).val(parseFloat(stok) - parseFloat(kurangiStok.val()));
                ...
                $("#<%=UpdatePanel1.ClientID %>").on("click", "[id*=GVBARANG] [id*=DetailButton]", function (e) {
                    ...
                    getStokSparepart(HFKODE_SPAREPART);
                    return false;
                });
                ...
                var beliGold = '';
                var beliGoldHD = '';
                function getStokSparepart(kdbarang) {
                    $.ajax({
                        type: "POST",
                        url: "Penerimaan.aspx/GET_STOK_BARANG",
                        ...
                        success: function (data) {
                            if (data.d.length > 0) {
                                ...
                                if (!alerted) {
                                    alertify.log('<img id="Image2" src="../../dist/img/info.png" style="height:30px;width:30px;" /><strong> Informasi!</strong> </br>Barang yang Anda pilih telah tersimpan sebelumnya dengan jumlah stok: ' + data.d[0].split('-')[4] + '. Anda akan meng-akumulasinya dengan stok yang baru untuk Nama Barang: ' + data.d[0].split('-')[3] + '. Proses ini akan meng-update semua stok pada Barang yang dipilih yang telah Anda simpan sebelumnya. Untuk detail lebih lanjut, silahkan klik link Barang.', "", 0);
                                }

                                $('#Gridview1_TXTSTOKAKHIR_' + parseInt($('#HFIDXSPAREPART').val())).text(data.d[0].split('-')[4]);
                                $('#Gridview1_TXTHARGABELI_' + parseInt($('#HFIDXSPAREPART').val())).val(data.d[0].split('-')[5]);
                                $('#Gridview1_TXTJUALGOLD_' + parseInt($('#HFIDXSPAREPART').val())).val(data.d[0].split('-')[7]);
                                $('#Gridview1_TXTJUALGOLDHD_' + parseInt($('#HFIDXSPAREPART').val())).val(data.d[0].split('-')[8]);
                                $('#Gridview1_TXTBELISTD_' + parseInt($('#HFIDXSPAREPART').val())).val(data.d[0].split('-')[3]);
                                $('#Gridview1_TXTBELIGOLD_' + parseInt($('#HFIDXSPAREPART').val())).val(data.d[0].split('-')[4]);
                                $('#Gridview1_TXTBELIGOLDHD_' + parseInt($('#HFIDXSPAREPART').val())).val(data.d[0].split('-')[5]);

                                $('#Gridview1_valQty_' + parseInt($('#HFIDXSPAREPART').val())).removeClass("form-group has-error default").addClass("form-group has-success");
                                $('#Gridview1_valHargaBeli_' + parseInt($('#HFIDXSPAREPART').val())).removeClass("form-group has-error").addClass("form-group has-success");
                                //$('#Gridview1_valHargaBeli_' + parseInt($('#HFIDXSPAREPART').val())).removeClass("form-group has-error default").addClass("form-group has-success");
                                //$('#Gridview1_valJual_Gold_' + parseInt($('#HFIDXSPAREPART').val())).removeClass("form-group has-error default").addClass("form-group has-success");
                                //$('#Gridview1_valJualGold_HD_' + parseInt($('#HFIDXSPAREPART').val())).removeClass("form-group has-error default").addClass("form-group has-success");
                                //$('#Gridview1_valBeliSTD_' + parseInt($('#HFIDXSPAREPART').val())).removeClass("form-group has-error default").addClass("form-group has-success");
                                //$('#Gridview1_valBeli_Gold_' + parseInt($('#HFIDXSPAREPART').val())).removeClass("form-group has-error default").addClass("form-group has-success");
                                //$('#Gridview1_valBeliGold_HD_' + parseInt($('#HFIDXSPAREPART').val())).removeClass("form-group has-error default").addClass("form-group has-success");

                                $('#Gridview1_LBDETAILQTY_' + parseInt($('#HFIDXSPAREPART').val())).css("visibility", "hidden");

                                stokLama = data.d[0].split('-')[1];
                                namaSparepart = data.d[0].split('-')[2];
                                //stokTotal = data.d[0].split('-')[1];
                                jualSTD = data.d[0].split('-')[6];
                                jualGold = data.d[0].split('-')[7];
                                jualGoldHD = data.d[0].split('-')[8];
                                beliSTD = data.d[0].split('-')[3];
                                beliGold = data.d[0].split('-')[4];
                                beliGoldHD = data.d[0].split('-')[5];
                                ...
                                $('#Gridview1_TXTQTY_' + parseInt($('#HFIDXSPAREPART').val())).val('');
                                $('#Gridview1_TXTJUALSTD_' + parseInt($('#HFIDXSPAREPART').val())).val('');
                                $('#Gridview1_TXTJUALGOLD_' + parseInt($('#HFIDXSPAREPART').val())).val('');
                                $('#Gridview1_TXTJUALGOLDHD_' + parseInt($('#HFIDXSPAREPART').val())).val('');
                                $('#Gridview1_TXTBELISTD_' + parseInt($('#HFIDXSPAREPART').val())).val('');
                                $('#Gridview1_TXTBELIGOLD_' + parseInt($('#HFIDXSPAREPART').val())).val('');
                                $('#Gridview1_TXTBELIGOLDHD_' + parseInt($('#HFIDXSPAREPART').val())).val('');

                                $('#Gridview1__' + parseInt($('#HFIDXSPAREPART').val())).removeClass("form-group has-success default").addClass("form-group has-error");
                                $('#Gridview1_valHargaBeli_' + parseInt($('#HFIDXSPAREPART').val())).removeClass("form-group has-success default").addClass("form-group has-error");
                                $('#Gridview1_valJual_Gold_' + parseInt($('#HFIDXSPAREPART').val())).removeClass("form-group has-success default").addClass("form-group has-error");
                                $('#Gridview1_valJualGold_HD_' + parseInt($('#HFIDXSPAREPART').val())).removeClass("form-group has-success default").addClass("form-group has-error");
                                $('#Gridview1_valBeliSTD_' + parseInt($('#HFIDXSPAREPART').val())).removeClass("form-group has-success default").addClass("form-group has-error");
                                $('#Gridview1_valBeli_Gold_' + parseInt($('#HFIDXSPAREPART').val())).removeClass("form-group has-success default").addClass("form-group has-error");
                                $('#Gridview1_valBeliGold_HD_' + parseInt($('#HFIDXSPAREPART').val())).removeClass("form-group has-success default").addClass("form-group has-error");

                                if (!alertedNewData) {
                                    alertify.set({ delay: 30000 });
                                    alertify.custom = alertify.extend("custom");
                                    alertify.custom('<img id="Image2" src="../../dist/img/info.png" style="height:30px;width:30px;" /><strong> Informasi!</strong> </br>Anda belum pernah menginput data ini sebelumnya. Anda akan menambahkan data baru. Harap semua isian pada tabel jangan dibiarkan kosong. Apabila ada item yang tidak diperlukan untuk diisi maka, isi dengan angka 0 (nol).');
                                }
                            }
                        }
                    });
                ...
                //$("body").on("keyup", "[id*=Gridview1] [id*=TXTQTY]", function () {
                //    var stokBaru = $(this).val();
                //    var displayStok = $(this).closest("td").find(".help-block");
                //    var kalkulasiStok = parseFloat(stokBaru) + parseFloat(stokLama);
                //    var showDetail = $(this).closest("td").find(".link-detail");

                //    //displayStok.text('Stok saat ini: ' + kalkulasiStok);
