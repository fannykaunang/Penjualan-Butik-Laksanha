<%@ Page Language="VB" AutoEventWireup="false" CodeFile="error_500.aspx.vb" Inherits="exception_error_500" %>
...
<head>
    ...
    <title>Penjualan Butik | Error 500 Unauthorized</title>
                ...
                <section class="content">
                    <div class="error-page">
                        ...
                        <div class="error-content">
                            <h3><i class="fas fa-exclamation-triangle text-danger"></i>&nbsp;Oops! ada yang tidak beres.</h3>

                            <p>
                                Anda tidak dapat mengakses langsung halaman yang diminta.
            Anda dapat <a href="../account/Login.aspx?next-url=~/kasir/input/Penerimaan.aspx">mencoba kembali</a>.
                            </p>
                        </div>
                    </div>
                    <!-- /.error-page -->
